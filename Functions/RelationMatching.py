from AlgorithmUtilities import createTypeBucket, getRel, getSemi, overLimit, sameRel, sameSource, sameTarget
from Relation import areDirectlyContraddictory, isFissa
